...
down_revision: str | Sequence[str] | None = "65697479b564"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "book_code", "chapter_number", name="uq_chapter_catalog_book_chapter"
        ),
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_notebook_chapters_notebook_id"), table_name="notebook_chapters"
    )
