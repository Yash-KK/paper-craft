[Figure 1](images/page_1_image_1.md)
...
[Figure 2](images/page_1_image_2.md)
...
[Figure 1](images/page_2_image_1.md)
...
[Figure 2](images/page_2_image_2.md)
...
Let us denote the first term of an AP by $a_1$, second term by $a_2, \dots, n$th term by $a_n$ and the common difference by $d$. Then the AP becomes $a_1, a_2, a_3, \dots, a_n$.
...
To obtain $d$ in a given AP, we need not find all of $a_2 - a_1, a_3 - a_2, a_4 - a_3, \dots$. It is enough to find only one of them.

Consider the list of numbers $1, 1, 2, 3, 5, \dots$. By looking at it, you can tell that the difference between any two consecutive terms is not the same. So, this is not an AP.
...
**Example 1 :** For the AP : $\frac{3}{2}, \frac{1}{2}, -\frac{1}{2}, -\frac{3}{2}, \dots$, write the first term $a$ and the common difference $d$.
...
= ₹ (8000 + 500 + 500 + 500)
= ₹ (8000 + 3 × 500)
= ₹ [8000 + (4 - 1) × 500] (for the 3rd year)
= ₹ 9000
Salary for the 5th year = ₹ (9500 + 500)
= ₹ (8000 + 500 + 500 + 500)
= ₹ (8000 + 4 × 500)
= ₹ [8000 + (5 - 1) × 500] (for the 4th year)
= ₹ 10000
...
$$\begin{aligned} &= \text{Salary for the 14th year} + ₹ 500 \\ &= ₹ \left[ 8000 + \frac{500 + 500 + 500 + \dots + 500}{13 \text{ times}} \right] + ₹ 500 \\ &= ₹ [8000 + 14 \times 500] \\ &= ₹ [8000 + (15 - 1) \times 500] = ₹ 15000 \end{aligned}$$

i.e., First salary + (15 - 1) × Annual increment.

In the same way, her monthly salary for the 25th year would be

$$\begin{aligned} &\quad ₹ [8000 + (25 - 1) \times 500] = ₹ 20000 \\ &= \text{First salary} + (25 - 1) \times \text{Annual increment} \end{aligned}$$
...
Let $a_1, a_2, a_3, \dots$ be an AP whose first term $a_1$ is $a$ and the common difference is $d$.

Then,

$$\text{the second term } a_2 = a + d = a + (2 - 1) d$$

$$\text{the third term } a_3 = a_2 + d = (a + d) + d = a + 2d = a + (3 - 1) d$$

$$\text{the fourth term } a_4 = a_3 + d = (a + 2d) + d = a + 3d = a + (4 - 1) d$$

$$\begin{aligned} \dots \dots \dots \\ \dots \dots \dots \end{aligned}$$

Looking at the pattern, we can say that the $n$th term $a_n = a + (n - 1) d$.

So, the $n$th term $a_n$ of the AP with first term $a$ and common difference $d$ is given by $a_n = a + (n - 1) d$.
...
$$a_3 = a + (3 - 1) d = a + 2d = 5 \quad (1)$$

and $a_7 = a + (7 - 1) d = a + 6d = 9 \quad (2)$
...
[tbl-0.md](tables/page_12_table_1.md)
...
So, the interest at the end of the 1st year = $$\text{₹} \frac{1000 \times 8 \times 1}{100} = \text{₹ } 80$$

The interest at the end of the 2nd year = $$\text{₹} \frac{1000 \times 8 \times 2}{100} = \text{₹ } 160$$

The interest at the end of the 3rd year = $$\text{₹} \frac{1000 \times 8 \times 3}{100} = \text{₹ } 240$$
...
[tbl-1.md](tables/page_13_table_1.md)
...
[Figure 1](images/page_15_image_1.md)
...
$$\text{Therefore, } S = \frac{22}{2} [16 + 21(-5)] = 11(16 - 105) = 11(-89) = -979$$
...
$$\text{so, } 1050 = \frac{14}{2} [20 + 13d] = 140 + 91d$$
...
Using the formula $S_n = \frac{n}{2}(a + l)$ for the sum of the first $n$ terms of an AP, we have

$$S_{1000} = \frac{1000}{2}(1 + 1000) = 500 \times 1001 = 500500$$

So, the sum of the first 1000 positive integers is 500500.

(ii) Let $S_n = 1 + 2 + 3 + \dots + n$
...
[Figure 1](images/page_22_image_1.md)
...
[Figure 2](images/page_22_image_2.md)
...
[Figure 3](images/page_22_image_3.md)
...
the bottom rungs are $2\frac{1}{2}$ m apart, what is the length of the wood required for the rungs?

[Hint : Number of rungs = $\frac{250}{25} + 1$]

[Figure 1](images/page_23_image_1.md)
...
[Figure 2](images/page_23_image_2.md)
...
2. A given list of numbers $a_1, a_2, a_3, \dots$ is an AP, if the differences $a_2 - a_1, a_3 - a_2, a_4 - a_3, \dots$, give the same value, i.e., if $a_{k+1} - a_k$ is the same for different values of $k$.
